...
//       setOutput(response.data.results || "No output returned"); // Display execution output
//     } catch (error) {
...
const QuestionDetail = () => {
  ...
  const handleRunCode = async () => {
    try {
      ...
      // Check if results exist and assign output
      setOutput(
  ...
  return (
    <div className="h-screen p-6 bg-gray-900 text-white grid grid-cols-2 gap-4">
      ...
      <div className="flex flex-col bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-4 bg-gray-900 text-white">
          <h3 className="text-lg font-semibold">Output:</h3>
          <pre className="bg-gray-800 p-2 rounded mt-2 text-green-400">
