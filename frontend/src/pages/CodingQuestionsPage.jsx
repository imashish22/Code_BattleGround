  ...
  return (
    <div className="bg-neutral-900 h-full min-h-screen">
      ...
      >
        ...
        <div className="absolute inset-0 -z-10">
  <div className="absolute top-20 left-6  text-orange-500 text-4xl ">
    {"</>"}
  </div>
  <div className="absolute bottom-32 left-12 text-blue-500 text-5xl opacity-30">
    {"{ }"}
  </div>
  <div className="absolute top-40 left-20 text-green-500 text-3xl opacity-25">
    {"//"}
  </div>
</div>   
<div className="text-center mt-8">
