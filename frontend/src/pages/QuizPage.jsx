...
//     />
//   );
// };// Assuming you're using a store for user authentication
...
//       username: user.name, // Include username if required
...
//               <button
//                 key={index}
//                 className={`block w-full bg-gray-700 text-l text-white  p-2 rounded mb-2 
