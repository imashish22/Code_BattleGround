...
//         <div>
//           <h3 className="text-md font-semibold text-orange-600 text-xl mb-4">Resources</h3>
...
//         </div>
//         <div>
//           <h3 className="text-md font-semibold text-orange-600 text-xl mb-4">Platform</h3>
//           <ul className="space-y-2">
...
//         </div>
//         <div>
//           <h3 className="text-md font-semibold text-orange-600 text-xl mb-4">Community</h3>
//           <ul className="space-y-2">
...
const Footer = () => {
  return (
    <footer className="px-9 pt-10 pb-5 w-full font-montserrat mt-32 text-white border-neutral-200 bg-gradient-to-r from-orange-500 to-orange-800 rounded-t-2xl">
