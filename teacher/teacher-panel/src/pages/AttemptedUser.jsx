...
//       <div className="max-w-5xl mx-auto mt-12 p-8 bg-gradient-to-r from-purple-600 to-indigo-600 shadow-2xl rounded-3xl text-white">
//       <h2 className="text-3xl font-extrabold text-center mb-6">Attempted Users</h2>
...
//                 <th className="px-6 py-3 text-lg">Attempted At</th>
//               </tr>
//             </thead>
//             <tbody>
//               {users.map((user, index) => (
//                 <tr key={user.studentId} className={`text-center ${index % 2 === 0 ? 'bg-indigo-500' : 'bg-purple-500'} hover:bg-indigo-400 transition-all` }>
//                   <td className="px-6 py-4 font-medium">{user.studentId.name}</td>
//                   <td className="px-6 py-4 font-semibold">{user.score}</td>
//                   <td className="px-6 py-4">{new Date(user.attemptedAt).toLocaleString()}</td>
//                 </tr>
//               ))}
//             </tbody>
//           </table>
