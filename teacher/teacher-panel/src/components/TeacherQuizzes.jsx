...
//       <h2 className="text-3xl font-bold text-center mb-6">Your Created Quizzes</h2>
...
//             <div 
//               key={quiz._id} 
//               className="p-6 bg-white shadow-lg rounded-2xl border border-gray-200 hover:shadow-xl transition cursor-pointer"
//               onClick={() => handleQuizClick(quiz._id)}
//             >
//               <h3 className="text-xl font-bold text-blue-700">{quiz.title}</h3>
//               <p className="text-gray-600">{quiz.description}</p>
//               <p className="text-sm text-gray-500 mt-2">Time Limit: {quiz.timeLimit} mins</p>
