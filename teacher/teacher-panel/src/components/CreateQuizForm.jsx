...
// import { FiLock, FiClock, FiUpload, FiFileText } from "react-icons/fi";
...
//     setQuiz({ ...quiz, file: e.target.files[0] });
//   };
...
//             className="w-full px-4 py-2 bg-purple-100 bg-opacity-20 border border-purple-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 text-black placeholder-grey shadow-inner"
...
//               value={quiz.password}
//               onChange={handleChange}
//               className="w-full pl-10 px-4 py-2 bg-purple-100 bg-opacity-20 border border-purple-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 text-black placeholder-grey shadow-inner"
...
//             value={quiz.deadline}
//             onChange={handleChange}
//             className="w-full px-4 py-2 bg-purple-100 bg-opacity-20 border border-purple-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 text-gray-500 placeholder-grey shadow-inner"
//             required
//           />
//         </div>
...
//               className="w-full pl-10 px-4 py-2 bg-purple-100 bg-opacity-20 border border-purple-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400 text-gray-500 placeholder-grey shadow-inner"
//               required
//             />
//           </div>
//         </div>
